...
Функция ПолучитьПредставлениеКонфигурации() Экспорт
	Возврат "Конфигурация """ + СокрЛП(Метаданные.Синоним)+""" Пользователь: " + СокрЛП(ПараметрыСеанса.ТекущийПользователь.Наименование);	
КонецФункции
