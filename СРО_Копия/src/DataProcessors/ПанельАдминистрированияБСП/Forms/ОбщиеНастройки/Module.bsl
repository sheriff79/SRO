...
&НаСервере
Процедура ЗаписатьКонстантыСРОПриЗакрытии()       
		
	Константы.СРО_АдресДляТестовойРассылки.Установить(НаборКонстант.СРО_АдресДляТестовойРассылки);
	Константы.СРО_ДополнительныйАдресЭлектроннойПочтыПоПредварительномуТестированию.Установить(НаборКонстант.СРО_ДополнительныйАдресЭлектроннойПочтыПоПредварительномуТестированию);    
	Константы.СРО_КаталогДляСохраненияДокументовРассылки.Установить(НаборКонстант.СРО_КаталогДляСохраненияДокументовРассылки);
	Константы.СРО_КаталогДляСформированныхПакетов.Установить(НаборКонстант.СРО_КаталогДляСформированныхПакетов);
	Константы.СРО_КаталогЗагруженныхФайловССайта.Установить(НаборКонстант.СРО_КаталогЗагруженныхФайловССайта);
	Константы.СРО_ПоследнийИсходящийНомерДокументаДляРассылки.Установить(НаборКонстант.СРО_ПоследнийИсходящийНомерДокументаДляРассылки);
	Константы.СРО_ПоследнийНомерПакетаВСРО_OD.Установить(НаборКонстант.СРО_ПоследнийНомерПакетаВСРО_OD);
	Константы.СРО_ПоследнийНомерПакетаВСРО_PS.Установить(НаборКонстант.СРО_ПоследнийНомерПакетаВСРО_PS);
	Константы.СРО_ПоследнийНомерПакетаВСРО_РазделыX_XI.Установить(НаборКонстант.СРО_ПоследнийНомерПакетаВСРО_РазделыX_XI);
	Константы.СРО_Должность_Иное.Установить(НаборКонстант.СРО_Должность_Иное); 	
	Константы.СРО_КаталогЗагруженныхФайловСЛичногоКабинета.Установить(НаборКонстант.СРО_КаталогЗагруженныхФайловСЛичногоКабинета);  	
	Константы.СРО_ПроверяемыйНомерВОчереди.Установить(НаборКонстант.СРО_ПроверяемыйНомерВОчереди);   	
	Константы.КаталогДляОбновленияЕГРЮЛ.Установить(НаборКонстант.КаталогДляОбновленияЕГРЮЛ);      
	Константы.УчетнаяЗаписьПочтыДляПроверки.Установить(НаборКонстант.УчетнаяЗаписьПочтыДляПроверки);
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	// Обновляем константы
	ЗаписатьКонстантыСРОПриЗакрытии();
...
&НаКлиенте
Процедура УстановитьИмяКаталога(ИмяРеквизита)           
	
	ДиалогВыбора = Новый ДиалогВыбораФайла(РежимДиалогаВыбораФайла.ВыборКаталога);
	ДиалогВыбора.Каталог = НаборКонстант[ИмяРеквизита];
	ДиалогВыбора.Заголовок = "Выберете каталог";
	ДиалогВыбора.МножественныйВыбор = Ложь;
	
	Если ДиалогВыбора.Выбрать() Тогда 
		 НаборКонстант[ИмяРеквизита] = ДиалогВыбора.Каталог;  
	КонецЕсли;

КонецПроцедуры	
	
&НаКлиенте
Процедура СРО_КаталогДляСохраненияДокументовРассылкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)	
	УстановитьИмяКаталога(Элемент.Имя);
КонецПроцедуры

&НаКлиенте
Процедура СРО_КаталогЗагруженныхФайловССайтаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	УстановитьИмяКаталога(Элемент.Имя);
КонецПроцедуры

&НаКлиенте
Процедура СРО_КаталогДляСформированныхПакетовНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	УстановитьИмяКаталога(Элемент.Имя);
КонецПроцедуры

&НаКлиенте
Процедура СРО_КаталогЗагруженныхФайловСЛичногоКабинетаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	УстановитьИмяКаталога(Элемент.Имя);
